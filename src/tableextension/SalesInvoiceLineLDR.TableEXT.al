/// <summary>
/// tableextension 50021 "Sales Invoice Line_LDR"
/// </summary>
tableextension 50021 "Sales Invoice Line_LDR" extends "Sales Invoice Line"
{
    fields
    {
    ...
    keys
    {
        key(Key10; Grouper_LDR, "Concept No._LDR")
        {
